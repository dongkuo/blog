  ...
  <div>
    ...
    <div>
      ...
      <span class="attribute">
        ...
        {{post.createdTime | date('friendly')}}
      </span>
    </div>
    <!--正文-->
    <div id="post">
      ...
      <!--点赞-->
      <p class="text-center">
        <app-thumbs-up :number="123"></app-thumbs-up>
      </p>
    </div>
    ...
    data() {
      return {
        ...
        comments: [
          ...
          {
            avatar: "http://img5.imgtn.bdimg.com/it/u=2748888549,3523102698&fm=27&gp=0.jpg",
            nickname: '狂曲想',
            ...
            replies: [
              {
                avatar: "http://img1.2345.com/duoteimg/qqTxImg/11/2012091910313510745.jpg",
                nickname: '装病的疯子',
              ...
              },
              {
                ...
                nickname: '花晓柳',
                content: "其实，按照别人说的改也没什么不好，前期自己的储备量不够，多听听别人的建议，但一定要明白为什么他要这么改，有没有更好的办法，以后遇到类似的该怎么处理",
          ...
          },
          {
            ...
            nickname: '蒋小坏',
            content: "是的，通常公司是不会让一个人掌握研发和采购两个渠道的资源的，因为这样锻炼出来的员工留下来的几率很小，人的想法是随着能力的不断提升而改变的，眼界也是，所以一个单兵能力强的人，最后的归属一定一定自主创业，这是唯一的出路。",
